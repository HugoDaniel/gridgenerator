	...
	return (
		<div className="dib">
			<nav className="flex flex-column bottom-circle">
				<a className="flex items-center justify-center w2 h2" href="#" onClick={props.onZoomIn} {...noPropagation} >
					<img className="w1 h1" src={zoom_in_icon} alt="Zoom in" />
				</a>
				<a className="flex items-center justify-center w2 h2" href="#" onClick={props.onZoomOut} {...noPropagation} >
