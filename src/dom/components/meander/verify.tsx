import { VerifyingState } from '../../../data';
...
export function MeanderVerify(props: IMeanderVerifyProps) {
	...
	return (
		<MeanderWrapper className="MeanderVerify" title={title} onExit={props.onExit}>
			<div className="w-100 h-100 flex items-center justify-center">
				<div className={`w5 ${h} pa3 ba br2 b--gray bg-white flex flex-column items-center justify-center`}>
					{verifyState(props)}
				</div>
			</div>
		</MeanderWrapper>
