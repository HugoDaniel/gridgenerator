...
<section className={`TemplatePicker mw6-ns ml5-ns flex-ns flex-column-reverse justify-start-ns h-100-ns pb6-ns ${props.className || ''}`}>
	<TemplateSelector
	...
	<div className="fixed bottom-4 mb3 static-ns flex w-100 ml5 pr5 items-center justify-center h2 bg-near-white pr0-ns mb4-ns mt2-ns h3-ns items-center-ns ml0-ns">
		<Button className="mr5 mr0-ns b--gray" color="gray" bg="near-white" label="Cancel" onAction={props.onCancel} />
	</div>
</section>
;
