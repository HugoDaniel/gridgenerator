import { FatState, Meander, PlayerState, ProjectMap, State, Project } from '../../data';
...
export class Refresher {
	...
	constructor(rro: (r: Runtime) => void, rso: (s: FatState) => void, rsdom: (s: FatState, action?: UpdateAction) => void, rdom: (action?: UpdateAction) => void, rmean: (m: Meander) => void, rproj: (p: ProjectMap) => void, rplay: (p: PlayerState) => void, rplaydom: (p: PlayerState, action?: UpdateAction) => void, rplayis: (p: PlayerState, s: State) => void, newp: (p: Project) => void) {
