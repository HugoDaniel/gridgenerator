...
import { ShapeFillSetId, ShapeId, Vector2D, VectorMap } from '../../data';
...
export class TextureManager {
	 ...
	 */
	public texturize(img: HTMLImageElement, canvas: CanvasRenderingContext2D, shapeId: ShapeId, shapeFillId: ShapeFillSetId, svg: string): Promise<TextureAtlas> {
