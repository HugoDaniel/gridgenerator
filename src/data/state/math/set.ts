...
export class VectorMap<T> {
	...
	public static revive(a: VectorMapReviver, reviveElem: (e: any) => any): VectorMap<any> {
...
export class VectorSet extends VectorMap<Vector2D> {
	...
	public static revive(a: Array<[number, number, any]>, reviveElem: (e: any) => any): VectorSet {
	...
	public filter(f: (v: Vector2D, x?: number, y?: number) => boolean): VectorSet {
