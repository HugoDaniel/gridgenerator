...
export enum MeanderCourse { Project = 100, Login, About, Collective, Pricing, Profile, Verify, Recover, None, ViewProject }
export class Meander {
	...
	private updateTitle() {
		switch (this._course) {
			...
			this._title = 'Login'; break;
			case MeanderCourse.About:
			this._title = 'About'; break;
			case MeanderCourse.Collective:
			this._title = 'Collective'; break;
			case MeanderCourse.Pricing:
			this._title = 'Pricing'; break;
			case MeanderCourse.Profile:
			this._title = 'Profile'; break;
