...
export class NetBilling {
	...
	constructor(hostname: string, doGet: (url: string, token?: Token) => Promise<any>, doPost: (url: string, data: object, token?: Token) => Promise<any>) {
	...
	public postNonce(t: Token, nonce: any, paymentType: string, billingInfo: any) {
		return this.postData(this.hostname + '/payments/checkout', { nonce, paymentType, billingInfo }, t)
