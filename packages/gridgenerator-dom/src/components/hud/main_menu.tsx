...
import { MainMenuId, Menu } from "gridgenerator-data";
...
export const MainMenu = (props: IMainMenuProps) => (
  <nav
    className={`MainMenu ${props.className ||
    ...
    {props.menu.map((_id, e, isSelected) => {
      ...
      return (
        <a
          ...
          key={`mainmenu-${id}`}
          {...noPropagation}
          className={`f7 no-underline black ttu sans-serif dib ph2 pb4 pt1 pointer top-bar ${
