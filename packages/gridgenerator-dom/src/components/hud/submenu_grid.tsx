  ...
  return (
    <div className="dib">
      <nav className="flex flex-column bottom-circle">
        ...
        >
          <img
            className={`w1 h1 ${!props.isGridVisible ? "o-40 grayscale" : ""}`}
            src={grid_view_icon}
            alt="Toggle Grid"
          />
        </a>
        ...
        >
          <img
            className={`w1 h1 ${!props.isPatternOn ? "o-40 grayscale" : ""}`}
            src={grid_pattern_icon}
            alt="Toggle Pattern"
          />
        </a>
        <p
          className="gray pa0 ma0 tc"
          style={{ "font-size": "0.5rem", transform: "translateY(0.4rem)" }}
        >
          ▲
        </p>
        <a
