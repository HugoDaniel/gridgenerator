...
export const PlayerControls = (props: IPlayerControls) => {
  const btncx =
    "button-reset bg-transparent pa0 pointer bn flex dim mh1 mh2-ns mv0";
  const normalBtn = "w2 h2 " + btncx;
  const bigBtn = "w3 h3" + btncx;
  const btnoff = " o-30";
  return (
    <nav
      className={`PlayerControls flex items-center justify-center ${props.className ||
        ""}`}
    >
      {props.isPlaying
        ? [
        ...
        : [
            <button
              className={normalBtn}
              onClick={props.isAtStart ? null : props.onToBegin}
            >
              <img
                className={props.isAtStart ? btnoff : ""}
                src={begin_icon}
                alt="To Start"
            ...
            <button
              className={normalBtn}
              onClick={props.isAtStart ? null : props.onPrev}
            >
              <img
                className={props.isAtStart ? btnoff : ""}
                src={prev_icon}
            ...
            <button
              className={normalBtn}
              onClick={props.isAtEnd ? null : props.onNext}
            >
              <img
                className={props.isAtEnd ? btnoff : ""}
                src={next_icon}
                alt="Next"
            ...
            <button
              className={normalBtn}
              onClick={props.isAtEnd ? null : props.onToEnd}
            >
              <img
                className={props.isAtEnd ? btnoff : ""}
                src={end_icon}
