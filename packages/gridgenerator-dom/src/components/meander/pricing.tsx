...
const PricingItem = props => (
  <li className="list-item f7 h2 flex items-center justify-left mv1">
    ...
    <p className="tl">{props.children}</p>
  </li>
);
      ...
      >
        <div className={props.sectionClassName}>
          ...
          <h2 className={props.subtitleClassName}>
            And help develop the app further.
          </h2>
          <div className="contact-social flex flex-wrap">
            ...
            >
              <ul className="list pl1">
                ...
                <PricingItem>
                  Automatic records your creation process
                </PricingItem>
            ...
            >
              <ul className="list pl1">
                <PricingItem>
                  <b>Buy customized products with your creations</b>
                </PricingItem>
            ...
            >
              <ul className="list pl1">
                <PricingItem>
                  <b>Adapt the tool to your desire</b>
                </PricingItem>
                <PricingItem>Use your domain</PricingItem>
                <PricingItem>
                  Advanced training for your end users and admins
                </PricingItem>
              </ul>
            </PricingCard>
          </div>
