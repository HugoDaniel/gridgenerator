...
export const AboutContact = (props: IAboutContactProps) => (
  <address className={`AboutContact user-select ${props.className}`}>
    ...
    <p className={props.textClassName}>
      Contact for all support requests{" "}
      <a className="link pointer" href="mailto:support@gridgenerator.com">
        here
      </a>
    </p>
    <h2 className={props.subtitleClassName}>Press Inquiries</h2>
    <p className={props.textClassName}>
      Contact for press and media questions{" "}
      <a className="link pointer" href="mailto:press@gridgenerator.com">
        here
      </a>
    </p>
    <h2 className={props.subtitleClassName}>General</h2>
    <p className={props.textClassName}>
      Can’t find the right category above ? Get in touch{" "}
      <a className="link pointer" href="mailto:contact@gridgenerator.com">
        here
      </a>
    </p>
    ...
    <p className={props.textClassName}>
      ...
      <a
        ...
        href="https://pt.wikipedia.org/wiki/Alenquer_(Portugal)"
      >
        Alenquer{" "}
      </a>{" "}
      I now spend most of my days in Lisbon. You can visit me at:
    </p>
    <p className={props.textClassName}>
      Rua Heróis de Quionga, n.25 r/c esq., 1170-178 Lisbon.{" "}
    </p>
  </address>
);
