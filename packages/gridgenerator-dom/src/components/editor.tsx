...
function selectEditor(
  ...
  shapeEditorProps: IShapeEditorProps,
  templateProps: ITemplatePickerProps,
  exportProps: IExportProps,
  publishProps: IPublishProps,
  productProps: IProductProps,
  saveProps: ISaveProps
) {
  switch (props.at) {
    ...
    case UIState.Export:
      return (
        <Export
          {...exportProps}
          height={props.height}
          onComponentDidMount={exportProps.events.onExportInit}
        />
      );
    case UIState.Save:
      return (
    ...
    case UIState.Publish:
      return <Publish {...publishProps} height={props.height} />;
    ...
    case UIState.Product:
      return (
        <Product
          onComponentDidMount={productProps.events.onProductInit}
          {...productProps}
        />
      );
    default:
      ...
      {props.at === UIState.FillEditor || props.at === UIState.ShapeEditor ? (
        ...
        >
          ...
          <NewCloseBtn
            ...
            className={`w2 h2 fixed mb4 bottom-2 ${
              isFillEditor ? "right-1" : "left-1"
            }`}
            big={false}
