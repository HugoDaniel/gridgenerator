...
export const TemplateSelector = (props: ITemplateSelectorProps) => (
  <nav
    className={`TemplateSelector ${props.className ||
      ""} list flex flex-wrap bg-near-white ph2 pv3 flex-column-ns items-center-ns justify-center-ns pv0-ns ph0-ns mt3-ns`}
  >
      ...
      return (
        <li className="list-item link pointer dim ph1">
          <svg
            ...
            viewBox={`-${props.margin / 2} -${props.margin /
              2} ${maxLen} ${maxLen}`}
