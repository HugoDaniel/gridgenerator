...
export function SystemPickerBtn(props: ISystemPickerBtnProps) {
  ...
  return (
    <label className={cx} style={props.style || {}}>
      <p
        className={
          "f7 sans-serif white ttu ws-normal tc h3 w3 br-100 ma0 flex flex-column justify-center"
        }
      >
        Click
        <br />
      ...
      <input
        ...
        id={"systempicker"}
        className={
          "not-visible w0 h0 absolute bn br-100 bg-transparent z-0 o-0"
        }
