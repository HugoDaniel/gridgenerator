...
import { Project } from "gridgenerator-data";
  ...
  return (
    ...
    >
      <section className="w-100 flex flex-column items-center justify-center">
        <h2 className="mv0">Congratulations</h2>
        <h3 className="mv0 f5">Project now online</h3>
        <div className="mt3 w-100 bt bb bg-white flex flex-column items-center justify-center">
          <h4 className="mt4 mb2">Access it on your "projects" menu</h4>
          <h4 className={`mt4 mb2`}>Share it</h4>
          ...
          <h4 className="mt4 mb1">Link</h4>
          <div className="flex flex-column items-center justify-center gray mb4">
            <a
              className="pointer link flex items-center justify-center"
              onClick={e => {
                e.preventDefault();
                const urlLink = document.getElementById(
                  "publish-url"
                ) as HTMLInputElement;
                urlLink.select();
                try {
            ...
            >
              <p
                className={`Button b--black-10 pa2 link f7 br1 mr3 transition-o ba bg-light-gray pointer near-black dim o-100 ttu`}
              >
                Copy
              </p>
              <input
                id="publish-url"
                className="input-reset bn sans-serif f6 bg-transparent h2 w5"
                value={projectUrl}
              />
            </a>
            <p>or MP4:</p>
