import { UIShapeEditor, UIShapeEditorMode } from "gridgenerator-data";
  ...
  switch (props.shapeEditor.editorMode) {
    ...
    default:
      if (props.shapeEditor.selectedShape > -1) {
        ...
        return <ShapeActionsMenu {...shapeAmbiguitiesProps} />;
      } else {
        // actions
        ...
        return <ShapeActionsMenu {...shapeActionsMenuProps} />;
      }
  }
}
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={props.isNotSmall ? { width: `${props.size}px` } : {}}
      >
        {chooseMenu(props)}
      </div>
    </div>
