...
import { PublishAt, PublishState, UIPublishEditor } from "gridgenerator-data";
  ...
  return (
    <a
      className={`link pointer ${
        isAvailable ? "dim" : "o-20"
      } flex items-center lh-copy pa3 ph0-l bb b--black-10 ${cx}`}
      onClick={isAvailable ? onAction : null}
    >
      <img
        className={`w2 h2 w3-ns h3-ns br-100 transition-o ${
          isSelected ? "o-100" : "o-40"
        }`}
        src={logo}
      />
    ...
    <section className="w-100 flex flex-column items-center justify-start h-100 overflow-auto pt4">
      ...
      <ul class="list pl0 mt0 measure center">
        ...
        {renderLicenseBadge(
          ...
          props.events.onLicenseCCBY,
          license.has("BY"),
          "Others must give appropriate credit, provide a link to the license, and indicate if changes were made."
        )}
        {renderLicenseBadge(
          true,
          "ml4",
          ccsa,
          "Share Alike",
          props.events.onLicenseCCSA,
          license.has("SA"),
          " If someone remixes, transforms, or builds upon this material, they must distribute their contributions under the same license as the original."
        )}
        {renderLicenseBadge(
          props.isPaidAccount,
          "ml4",
        ...
        {renderLicenseBadge(
          ...
          ccnd,
          "No Derivatives",
          props.events.onLicenseCCND,
          license.has("ND"),
          "If others remix, transform, or build upon this material, they may not distribute the modified material."
        )}
      </ul>
...
function renderMetadata(props: IPublishProps) {
  ...
  return (
    <section className="w-100 flex flex-column items-center justify-center">
      <h2 className="mv0">Publish</h2>
      <h3 className="mv0 f5">And share with your friends</h3>
      <div className="mt3 w-100 bt bb bg-white flex flex-column items-center justify-center">
        <h4 className={`mt4 mb1`}>Title</h4>
        ...
        <h4 className={subtitleCx}>Description</h4>
        <div className="flex items-center justify-center gray">
          <TextArea
            id="publish-desc"
        ...
        <h4 className={subtitleCx}>License</h4>
