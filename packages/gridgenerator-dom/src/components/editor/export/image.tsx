  ...
  return (
    <section className={`ExportImage flex ${props.className || ""}`}>
      ...
      <div className="info">
        ...
        <div className="flex items-start justify-start flex-wrap gray">
          <a
            ...
            className={`flex items-center justify-center mt2 mr2 w3 h2 ba pa2 f7 link dim ttu dark-gray pointer ${
              props.data.format === ExportEditorFormat.SVG
                ? "bw2 b--blue black"
                : "gray b--gray"
            }`}
          >
          ...
          <a
            onClick={linkEvent(
              ExportEditorFormat.PNG,
              props.events.onFormatChange
            )}
            className={`flex items-center justify-center mt2 mr2 w3 h2 ba pa2 f7 link dim ttu dark-gray pointer ${
              props.data.format === ExportEditorFormat.PNG
                ? "bw2 b--blue black"
                : "gray b--gray"
            }`}
          >
        ...
        <h2 className="mt3 mb0 f7">Size</h2>
        <div className="flex items-start justify-start flex-wrap gray">
          <a
            onClick={linkEvent(ExportSize.HDReady, props.events.onSizeChange)}
            className={`flex items-center justify-center mt2 mr2 w2 h2 ba pa2 f7 link dim ttu dark-gray pointer ${
              props.data.size === ExportSize.HDReady
                ? "bw2 b--blue black"
                : "gray b--gray"
            }`}
          >
          ...
          <a
            onClick={linkEvent(ExportSize.FullHD, props.events.onSizeChange)}
            className={`flex items-center justify-center mt2 mr2 w2 h2 ba pa2 f7 link dim ttu dark-gray pointer ${
              props.data.size === ExportSize.FullHD
                ? "bw2 b--blue black"
                : "gray b--gray"
            }`}
          >
          ...
          <a
            onClick={linkEvent(ExportSize.UHD, props.events.onSizeChange)}
            className={`flex items-center justify-center mt2 mr2 w2 h2 ba pa2 f7 link dim ttu dark-gray pointer ${
              props.data.size === ExportSize.UHD
                ? "bw2 b--blue black"
                : "gray b--gray"
            }`}
          >
        ...
        <h2 className="mt3 mb0 f7">Dimension</h2>
        <p className="ma0 pa0 f7 ttu">
          {Math.ceil(res.width)} ✕ {Math.ceil(res.height)}
        </p>
        <h2 className="mt3 mb0 f7">Pattern</h2>
        <input
          className="w3 w4-ns"
          type="range"
          min="1"
