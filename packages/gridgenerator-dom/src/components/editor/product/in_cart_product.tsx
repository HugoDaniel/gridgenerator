...
import { CartProduct, ProductAt } from "gridgenerator-data";
    ...
    case ProductAt.Poster:
      return (
        <div className={pcx}>
          ...
          <h2 className={scx}>
            Size: <span>{product.posterType}</span>
          </h2>
        </div>
      );
    case ProductAt.TShirt:
      return (
        <div className={pcx}>
          <h1 className={tcx}>{product.productType()}</h1>
          <h2 className={scx}>
            Size: <span>{product.tshirtSize}</span>
          </h2>
          <h2 className={scx}>
            Type: <span>{product.tshirtType}</span>
          </h2>
          <h2 className={scx + " flex items-center justify-start"}>
            Color:{" "}
            <div
              className="mh2 ba w1 h1"
              style={{ background: product.tshirtColor }}
            />
          </h2>
        </div>
      );
