...
export class ColorMap {
  ...
  public static revive(r: IColorMapReviver): ColorMap {
    ...
    const colorsMap = r.colors.map(
      ([id, c]) => [id, RGBColor.revive(c)] as [number, RGBColor]
    );
  ...
  public duplicateColor(colorId: ColorId, newId: ColorId) {
    ...
    this.colors.set(newId, new RGBColor(color.r, color.g, color.b, color.a));
  }
  public iter() {
